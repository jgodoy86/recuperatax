...
export default function Concesionarios() {
  return (
    <div className="mx-auto max-w-4xl px-4 py-14">
      <p className="mb-3 inline-block rounded-full bg-brand-100 px-3 py-1 text-xs font-bold uppercase tracking-wide text-brand-800">
        Programa para concesionarios
      </p>
      <h1 className="text-4xl font-black leading-tight">
        Ayudamos a tus clientes a recuperar el IVA,{" "}
        <span className="text-brand-600">sin cargas para tu equipo</span>
      </h1>
      ...
      <div className="card mt-10 border-brand-300 bg-brand-50/50 text-center">
